...
\contentsline {lstlisting}{\numberline {2.1}Requ\IeC {\^e}te d'un token}{6}{lstlisting.2.1}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {2.2}Retourne le token}{6}{lstlisting.2.2}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {2.3}Soumet un \IeC {\'e}v\IeC {\`e}nement}{6}{lstlisting.2.3}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {2.4}Exemple d'utilisation de tracker.js}{7}{lstlisting.2.4}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {2.5}Requ\IeC {\^e}te PATCH \IeC {\`a} l'api}{8}{lstlisting.2.5}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {2.6}Affichage identifiant avec le routeur}{8}{lstlisting.2.6}
\defcounter {refsection}{0}\relax 
